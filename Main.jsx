        ...
        <div className="h-screen w-full">
            ...
            <div className="md:flex flex-col "> 
                <div className="flex justify-center">
                    <img className="w-96 max-sm:w-96 mt-10" src={logoTopo} />
                </div>
                <h1 className="text-tema font-dm mt-5 text-5xl text-dm-sans text-center max-sm:text-3xl" >EVERYTHING YOU NEED FROM A BANK IN ONE PLACE</h1>
                ...
                <div className='flex justify-around mt-16'>
                    <h1 className='text-6xl w-2/5 text-center flex items-center max-sm:hidden'>Ask for your card without annuity</h1>
                    <img className='w-52 max-sm:hidden' src={cartao} />
                    <h1 className='text-[7rem] leading-[110.67px] w-2/5 text-center flex items-center md:hidden'>Ask for your card without annuity</h1>
                    <img className='w-96 md:hidden' src={cartao} />
                </div>
{/* 
