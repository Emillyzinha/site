    ...
    return (
        <div className="h-screen w-full">
            ...
            <div className="flex flex-col">
                ...
                <WeAre img={aviao} ml={'ml-[42%]'} mt={'mt-[10rem]'} />
                <WeAreRight img={college} />
                <WeAre img={finances} ml={'ml-[40%]'} mt={'mt-[8.6rem]'} />
                ...
                <div className='w-full flex justify-around mt-32'>
                    <img src={bancoMobile} />
                    <div className='w-1/2 '>
                        <h1 className='text-9xl text-center flex items-center'>Download our app and get access to our services</h1>
                        <div className='mt-32 flex h-32 justify-between'>
                            <img className='w-96' src={appStore} />
                            <img className='w-96' src={playStore} />
                        </div>
                    </div>
                </div>
                <div className="w-full flex justify-center">
                    <div className="bg-temaCinza h-[30rem] w-[85%] flex mt-32 items-center">
                        <h1 className='w-1/2 text-6xl flex items-center text-center p-20'>We are a bank focused on helping you, so we have a series of benefits for you!</h1>
                        ...
                        <div className="w-1/2 flex flex-col items-center justify-center">
                            ...
                            <div className="w-[32em] flex mt-12">
                                ...
                                <button className='w-1/4 h-16 bg-[#000] text-[#fff]'>Send</button>
                            </div>
                        </div>
                    </div>
                </div>
